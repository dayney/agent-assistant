---
description: Use when designing, reviewing, or implementing the macOS-first agentsync
  desktop client under desktop/, especially its navigation, Rule workflows, windows,
  menus, keyboard interaction, visual polish, accessibility, or Apple HIG alignment
  in the existing Tauri and React stack.
