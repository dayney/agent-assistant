...
description: Enforce the project's existing technology stack, coding rules, font boundary, and explicit adapter capability limits before an AI agent edits code.
---
