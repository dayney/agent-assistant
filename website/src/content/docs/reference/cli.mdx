...
| `governance scan\|init\|check\|capabilities` | Read or initialize a project Baseline/Profile contract before Agent edits; reports capability loss explicitly. | `--scope --project --profile --agents --dry-run --force --json` |
